...
namespace MS.Extensions.Fabric.Query
{
    ...
    internal class ApplicationTypeListWrapper : IApplicationTypeList
    {
        private readonly IList<ApplicationType> _items;
        ...
        public ApplicationTypeListWrapper(IList<ApplicationType> items)
        {
